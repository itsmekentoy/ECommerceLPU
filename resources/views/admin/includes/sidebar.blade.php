<div class="w-64 bg-white shadow-sm border-r border-gray-200 fixed h-full overflow-y-auto">
    <nav class="mt-8 px-4">
        <ul class="space-y-2">
            ...
            <!-- Orders -->
            <li>
                <a href="{{ route('customer.orders') }}" class="text-gray-700 hover:bg-primary hover:text-white group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
