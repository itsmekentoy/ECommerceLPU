...
<main class="checkout-main">
    <div class="checkout-container">
        ...
        <!-- Checkout Form -->
        <form action="{{ route('order.place.direct') }}" method="POST" class="checkout-form" id="checkoutForm" style="display: none;"enctype='multipart/form-data'>
            @csrf
            <input type="hidden" name="item_id" id="hiddenItemId">
            <input type="hidden" name="quantity" id="hiddenQuantity">
            <!-- Pass selected textile/customization id for direct orders -->
            <input type="hidden" name="customization" id="hiddenCustomization">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('hiddenCustomization').value = item.customization ?? '';
